...
const EduCard = ({
  ...
  >
    ...
    <div className="mt-2">
      <h3 className="text-xl font-shrikhand leading-tight mb-1">
        {title}
      </h3>
      ...
      <div className="text-sm font-medium bg-white/60 p-3 rounded-lg border-2 border-black/10">
        {details}
      </div>
    </div>
    ...
    <div className="h-[700px] md:h-[900px] w-full bg-[#2a2a2a] border-8 border-custom-yellow rounded-3xl shadow-neo relative overflow-hidden group">
      ...
      <div className="absolute top-4 left-4 z-10 flex gap-2 bg-white/10 backdrop-blur-sm p-2 rounded-xl border-2 border-white/20">
        ...
        <button
          ...
          className={`p-2 rounded-lg transition-all ${
            color === '#FCD34D'
              ? 'bg-custom-yellow text-black scale-110'
        ...
        <button
          ...
          className={`p-2 rounded-lg transition-all ${
            color === '#F87171'
              ? 'bg-custom-red text-black scale-110'
  ...
  const educationData = [
    {
      ...
      place: 
        'IIT Patna & IIIT Ranchi, Patna (Full Time Hybrid Programme conducted in collaboration with IIT Patna & IIIT Ranchi)',
      color: 'bg-purple-100',
      details: (
        <ul className="list-disc list-inside space-y-1">
          <li>Focused on advanced system programming and scalable application development.</li>
          <li>Learning cybersecurity concepts with interest in IAM technologies.</li>
          <li>Relevant Coursework: System Programming, CyberSecurity (IAM), RDBMS, Mathematics.</li>
        </ul>
      ),
    },

    {
      ...
      place:
        'Lalit Narain Tirhut Mahavidyalaya (B. R. Ambedkar Bihar University, Muzaffarpur)',
      color: 'bg-blue-100',
      details: (
        <ul className="list-disc list-inside space-y-1">
          <li>Built strong foundation in programming, OOPs, and database management.</li>
          <li>Improved problem-solving and software development skills.</li>
          <li>Relevant Coursework: System Programming, OOPs Concept, DBMS, Operating System, Mathematics.</li>
        </ul>
      ),
    },

    {
      ...
      place: 'Bihar School Examination Board, Patna',
      color: 'bg-green-100',
      details: (
        <ul className="list-disc list-inside space-y-1">
          <li>Studied core science subjects with focus on analytical thinking.</li>
          <li>Subjects: Mathematics, Physics, Chemistry, Hindi, English.</li>
        </ul>
      ),
    },
  ];
